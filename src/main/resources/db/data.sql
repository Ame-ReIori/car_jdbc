...
INSERT INTO  `CAR_DETECTION_TABLE` (`CAR_ID`,`ASSESSOR_ID`,`ADMIN_ID`,`ENGINE`,`WINDOW`,`WHEEL`,`COLLISION`,`LIGHT`,`APPEARANCE`,`DASHBOARD`,`CHASSIS`,`SECURITY_SYSTEM`)VALUES (2,2,1,'bad','awful','perfect','null','normal','perfect','good','good','normal');
INSERT INTO  `CAR_DETECTION_TABLE` (`CAR_ID`,`ASSESSOR_ID`,`ADMIN_ID`,`ENGINE`,`WINDOW`,`WHEEL`,`COLLISION`,`LIGHT`,`APPEARANCE`,`DASHBOARD`,`CHASSIS`,`SECURITY_SYSTEM`)VALUES (3,3,1,'good','not bad','perfect','null','normal','perfect','good','good','normal');
INSERT INTO  `CAR_DETECTION_TABLE` (`CAR_ID`,`ASSESSOR_ID`,`ADMIN_ID`,`ENGINE`,`WINDOW`,`WHEEL`,`COLLISION`,`LIGHT`,`APPEARANCE`,`DASHBOARD`,`CHASSIS`,`SECURITY_SYSTEM`)VALUES (4,4,1,'bad','awful','perfect','null','normal','perfect','good','good','normal');
